...
class FRFCFS : public IScheduler, public Implementation {
  ...
  public:
    ...
    ReqBuffer::iterator compare(ReqBuffer::iterator req1, ReqBuffer::iterator req2) override {
      ...
      //print out req1 and req2 command
      std::cout << "req1 command: " << req1->command << std::endl;
      std::cout << "req2 command: " << req2->command << std::endl;
      // print out addr_vec of req1 and req2
      std::cout << "req1 addr_vec: ";
      for (auto i : req1->addr_vec) {
        std::cout << i << " ";
      }
      std::cout << std::endl;
      std::cout << "req2 addr_vec: ";
      for (auto i : req2->addr_vec) {
        std::cout << i << " ";
      }
      std::cout << std::endl;
